...
public class TestKeyboardSimulator implements KeyboardSimulator {
    ...
    public TestKeyboardSimulator() {
        ...
        this.autoDelay = 0;
        log.info("TestKeyboardSimulator initialized - no actual key presses will occur");
    }
    ...
    public void keyPress(int keyCode) {
        ...
        log.debug("Test key pressed: {} (total pressed: {})", keyCode, pressedKeys.size());
    }
    ...
    public void keyRelease(int keyCode) {
        ...
        log.debug("Test key released: {} (total pressed: {})", keyCode, pressedKeys.size());
    }
    ...
    public void releaseAllKeys() {
        log.info("Test mode: releasing all {} pressed keys", pressedKeys.size());
