...
public class MidiFileDao implements MidiFileRepository {
    ...
    public MidiFile save(MidiFile midiFile) {
        ...
        try (Connection conn = databaseManager.getConnection();
            ...
            log.debug("Saved MIDI file: {}", midiFile);
            return midiFile;
    ...
    public MidiFile update(MidiFile midiFile) {
        ...
        try (Connection conn = databaseManager.getConnection();
            ...
            log.debug("Updated MIDI file: {}", midiFile);
            return midiFile;
    ...
    public boolean delete(Long id) {
        ...
        try (Connection conn = databaseManager.getConnection();
            ...
            log.debug("Deleted MIDI file with id: {}, affected: {}", id, affected);
            return affected > 0;
    ...
    public int deleteByRootDirectory(Long rootDirectoryId) {
        ...
        try (Connection conn = databaseManager.getConnection();
            ...
            log.debug("Deleted {} MIDI files for root directory: {}", affected, rootDirectoryId);
            return affected;
    ...
    public void saveNoteShift(Long midiFileId, int noteShift) {
        ...
        try (Connection conn = databaseManager.getConnection();
            ...
            log.debug("Saved note shift for MIDI file {}: {}", midiFileId, noteShift);
