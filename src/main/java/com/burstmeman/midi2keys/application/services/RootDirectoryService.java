...
public class RootDirectoryService {
    ...
    private static final Logger logger = LoggerFactory.getLogger(RootDirectoryService.class);
    ...
    public RootDirectory addRootDirectory(String path, String name) {
        ...
        logger.info("Added root directory: {}", saved);
        return saved;
    }
    ...
    public RootDirectory updateRootDirectoryName(Long id, String name) {
        ...
        logger.info("Updated root directory name: {}", updated);
        return updated;
    }
    ...
    public boolean removeRootDirectory(Long id) {
        ...
        if (deleted) {
            logger.info("Removed root directory: {}", id);
        ...
        List<RootDirectory> invalidDirs = allDirs.stream()
                ...
                .peek(dir -> {
                    if (dir.isActive()) {
                        ...
                        logger.warn("Deactivated invalid root directory: {}", dir.getPath());
                    }
                })
                .toList();
