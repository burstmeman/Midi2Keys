...
public class PreviewController implements Initializable {
    ...
    public void initialize(URL location, ResourceBundle resources) {
        log.info("Initializing PreviewController");
    ...
    private void onReanalyze() {
        ...
        task.setOnFailed(e -> {
            log.error("Failed to re-analyze file", task.getException());
            Platform.runLater(() -> {
    ...
    private void onNoteShiftChanged() {
        ...
        try {
            ...
            log.debug("Updated note shift to {} for file {}", noteShift, currentFile.getId());
        } catch (Exception e) {
