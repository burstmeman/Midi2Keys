...
public class MainController implements Initializable {
    ...
    @FXML private VBox fileBrowserPane;
    ...
    @FXML private ListView<Object> fileListView;
    @FXML private Label fileBrowserStatusLabel;
    ...
    @FXML private ScrollPane previewContentPane;
    @FXML private VBox previewEmptyPane;
    ...
    // Test mode indicator
    @FXML private HBox testModeIndicator;
    ...
    private void onAddRootDirectory() {
        logger.info("Add root directory clicked");
    ...
    private void onManageProfiles() {
        logger.info("Manage profiles clicked");
        openProfileManagerDialog();
    }
    ...
    private void openProfileManagerDialog() {
        try {
            ...
            logger.error("Failed to open profile manager dialog", e);
    ...
    private void onNoteShiftChanged() {
        ...
        try {
            ...
            logger.debug("Updated note shift to {} for file {}", noteShift, selectedFile.getId());
        } catch (Exception e) {
    ...
    private void onProfileSelected(Profile profile) {
        try {
            ...
            logger.info("Selected profile: {}", profile.getName());
            updateStatus("Profile: " + profile.getName());
        } catch (Exception e) {
            logger.error("Failed to select profile", e);
        }
    }
    ...
    public void panicStop() {
        logger.warn("PANIC STOP triggered");
        if (playMidiFileUseCase != null) {
