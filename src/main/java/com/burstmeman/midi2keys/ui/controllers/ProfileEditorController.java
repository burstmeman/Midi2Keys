...
public class ProfileEditorController implements Initializable {
    ...
    private static final Logger logger = LoggerFactory.getLogger(ProfileEditorController.class);
    ...
    // Mappings section
    @FXML private ListView<NoteMapping> mappingListView;
    ...
    @FXML private ComboBox<Quantization> quantizationCombo;
    @FXML private Slider velocityThresholdSlider;
    @FXML private Label velocityValueLabel;
    @FXML private Slider transposeSlider;
    @FXML private Label transposeValueLabel;
    @FXML private Slider keyDurationSlider;
    @FXML private Label keyDurationValueLabel;
    
    // Channel toggles
    @FXML private VBox channelTogglesContainer;
    ...
    public void initialize(URL location, ResourceBundle resources) {
        logger.info("Initializing ProfileEditorController");
