...
public class ProfileManagerController implements Initializable {
    ...
    private static final Logger logger = LoggerFactory.getLogger(ProfileManagerController.class);
    ...
    @FXML private Label mappingCountLabel;
    ...
    public void initialize(URL location, ResourceBundle resources) {
        logger.info("Initializing ProfileManagerController");
    ...
    private void openProfileEditor(Profile profile) {
        logger.info("Opening profile editor for: {}", profile.getName());
